...
import { registerUser, loginUser, logoutUser, resetPasswordToken, resetPassword, changePassword, getUserDetails, updateUserProfile, getAllUsers, getAUser, deleteAUser, updateUserRole } from "../controllers/userController.js"
...
router.route("/admin/user/:id").get(auth, authorizeRoles("admin"), getAUser)

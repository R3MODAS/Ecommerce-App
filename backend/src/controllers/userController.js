...
export const resetPassword = AsyncHandler(async (req, res, next) => {
    ...
    try {
        ...
        await mailer(user.email, `Reset Password Successful | Ecommerce`, `Password for ${user.email} is updated successfully`)
...
export const changePassword = AsyncHandler(async (req, res, next) => {
    ...
    // validation of data
    await changePasswordSchema.validateAsync({ oldPassword, newPassword, confirmNewPassword })
